    ...
    <footer className="border-t border-primary-100 bg-primary-900 text-white dark:border-white/10">
      <div className="container-page grid gap-8 py-10 sm:grid-cols-2 sm:gap-10 sm:py-14 lg:grid-cols-4">
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-white/70 sm:mt-4">{t("tagline")}</p>
          <div className="mt-4 flex gap-3">
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 transition hover:bg-gold-500/80"
            >
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-white/70 sm:mt-4 sm:space-y-2.5">
            ...
            <li className="flex items-center gap-2 pt-1">
              ...
              <a href="mailto:info@yerevanrealestate.am" className="break-all transition hover:text-gold-400">
        ...
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-2.5 text-sm font-medium text-white/90 transition hover:border-gold-400 hover:text-gold-400"
          >
            WhatsApp Us
          </a>
        </div>
      ...
      <div className="border-t border-white/10 py-4 text-center text-xs text-white/40 sm:py-5">
